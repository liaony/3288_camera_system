...
const IsiRegDescription_t OV2685_g_aRegDescription[] =
{
	...
	{0x3820,0xc2,"",eReadWrite}, //vsub48_blc on, vflip_blc on, vbinf on,														  
	{0x3821,0x01,"",eReadWrite}, //Mirror on, hbin on																			  
	{0x3820,0xc2,"",eReadWrite}, //vsub48_blc on, vflip_blc on, Flip on, vbinf on,												  
	{0x3821,0x01,"",eReadWrite}, //hbin on																						  
	{0x3820,0xc2,"",eReadWrite}, //vsub48_blc on, vflip_blc on, Flip on, vbinf on,												  
	{0x3821,0x01,"",eReadWrite}, //Mirror on, hbin on																			  
	...
	{0x5184,0x78,"",eReadWrite}, //78; cwf_x																					  
	{0x5185,0x58,"",eReadWrite}, //cwf_y																						  
	{0x5186,0xB5,"",eReadWrite}, //kx(cwf 2 a)x2y																				  
	{0x5187,0xB2,"",eReadWrite}, //Ky(cwf 2 day)y2x 																			  
	{0x5188,0x08,"",eReadWrite}, //cwf range																					  
	{0x5189,0x0e,"",eReadWrite}, //a range																						  
	{0x518a,0x0C,"",eReadWrite}, //day range																					  
	{0x518b,0x4C,"",eReadWrite}, //day limit																					  
	{0x518c,0x38,"",eReadWrite}, //a limit																						  
	...
	{0x5801,0x24,"",eReadWrite}, //red x0 L 																					  
	{0x5802,0x02,"",eReadWrite}, //red y0 H 																					  
	{0x5803,0x40,"",eReadWrite}, //red y0 L 																					  
	{0x5804,0x34,"",eReadWrite}, //red a1																						  
	{0x5805,0x05,"",eReadWrite}, //red a2																						  
	{0x5806,0x12,"",eReadWrite}, //red b1																						  
	{0x5807,0x05,"",eReadWrite}, //red b2																						  
	{0x5808,0x03,"",eReadWrite}, //green x0 H																					  
	{0x5809,0x3C,"",eReadWrite}, //green x0 L																					  
	{0x580a,0x02,"",eReadWrite}, //green y0 H																					  
	{0x580b,0x40,"",eReadWrite}, //green y0 L																					  
	{0x580c,0x26,"",eReadWrite}, //green a1 																					  
	...
	{0x5811,0x28,"",eReadWrite}, //blue x0 L																					  
	{0x5812,0x02,"",eReadWrite}, //blue y0 H																					  
	{0x5813,0x40,"",eReadWrite}, //blue y0 L																					  
	{0x5814,0x24,"",eReadWrite}, //bule a1																						  
...
const IsiRegDescription_t OV2685_g_1600x1200[] =
{
	...
	{0x3820,0xc0,"",eReadWrite}, // vsub48_blc on, vflip_blc on, vbinf off, 				  
	{0x3821,0x00,"",eReadWrite}, // Mirror on, hbin off 									  
	{0x3820,0xc0,"",eReadWrite}, // vsub48_blc on, vflip_blc on, Flip on, vbinf off,		  
	{0x3821,0x00,"",eReadWrite}, // hbin off												  
	{0x3820,0xc0,"",eReadWrite}, // vsub48_blc on, vflip_blc on, Flip on, vbinf off,		  
	{0x3821,0x00,"",eReadWrite}, // Mirror on, hbin off 									  
	{0x382a,0x00,"",eReadWrite}, // fixed VTS												  
